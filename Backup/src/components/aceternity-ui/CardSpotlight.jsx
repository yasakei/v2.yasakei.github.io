...
export const CardSpotlight = ({
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full h-full overflow-hidden rounded-xl border border-black/[0.2] dark:border-white/[0.2] bg-white/30 dark:bg-black/30 backdrop-blur-xl shadow-2xl",
        className
      )}
      {...props}
    >
