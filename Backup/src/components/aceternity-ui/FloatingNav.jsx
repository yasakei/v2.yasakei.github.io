...
const FloatingNav = ({ navItems, theme, setTheme, className = "" }) => {
  ...
  return (
    <div className={`fixed top-4 inset-x-0 max-w-4xl mx-auto z-50 ${className}`}>
      <div className="relative rounded-full border border-black/[0.2] dark:border-white/[0.2] bg-white/80 dark:bg-black/20 backdrop-blur-xl shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
        <div className="flex items-center justify-between px-8 py-4">
          <div className="text-3xl font-bold font-cursive text-black dark:text-white">
            Yasakei
          </div>
