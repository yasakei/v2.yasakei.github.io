...
const SceneUpdater = ({ meshRef, theme, color, speed, scale, noiseIntensity, rotation }) => {
  ...
  }, [speed, scale, noiseIntensity, rotation, meshRef]);
...
const Silk = ({
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uColor: { value: new Color(...hexToNormalizedRGB(theme === 'dark' ? color : '#E5E7EB')) },
  ...
  return (
    <Canvas dpr={[1, 2]} frameloop="always">
      ...
      <SceneUpdater meshRef={meshRef} theme={theme} color={color} speed={speed} scale={scale} noiseIntensity={noiseIntensity} rotation={rotation} />
    </Canvas>
  );
};
